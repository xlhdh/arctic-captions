...
# Load image splits 
trainimages = open('../category/indoor/indoor_train.txt','r').read().splitlines()
valimages = open('../category/indoor/indoor_val.txt','r').read().splitlines()
testimages = open('../category/indoor/indoor_test.txt','r').read().splitlines()
